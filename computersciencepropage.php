...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
    ...
    header('Location: ..\agri\alert.php');
}
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>stuHelp | Computer Science</title>
    <meta name="description" content="stuHelp is eager to help all our school students at any time and place with projects!!" />
    <meta name="keywords" content="stuHelp,computer science projects , c++,programming projects ,coding"/>
    ...
    <link rel="shortcut icon" href="..\agri\img\favicon-16x16.png" type="image/x-icon">
  ...
  <body>
    ...
    <div class="section #424242 grey darken-3" style="color: white;">
        <div style="padding-left: 20px;">
            <h5>COMPUTER SCIENCE PROJECTS</h5>
            <p>Check out the best computer science school projects available online </p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- so this is the project card which is going to repeat -->
                    <a href="facultydatabase.html" style="color: black;">
                    <div class="card animated fadeIn" style="border-bottom: 10px solid red;">
                        ...
                        <div class="card-content">
                            <p>C++ based Project which emulates the working of a computer shop.</p>
                        </div>
                ...
                <div class="col m4 s12">
                    <a href="cabshare.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                        ...
                        <div class="card-content">
                            <p>C++ based Project to manage a railway ticket reservation service using OOP and data file handling.</p>
                        </div>
                        <div class="card-action" >
                            <p class="viewproject">View Project</p>
                        </div>
                ...
                <div class="col m4 s12">
                    <a href="allaboutvit.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                         <div class="row imageshowincard">
                            <div class="col s6">
                                <h5>Snake Game</h5>
                        ...
                        <div class="card-content">
                            <p>Implementation of Snake game using C++.</p>
                        </div>
                        <div class="card-action">
                            <p class="viewproject">View Project</p>
                        </div>
            ...
            <div class="row" style="margin-bottom: 0;">
                <div class="col m4 s12">
                <!-- so this is the project card which is going to repeat -->
                    <a href="pravega.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                        <div class=" row imageshowincard">
                            <div class="col s6">
                        ...
                        <div class="card-content">
                            <p>C++ based project on Student management.</p>
                        </div>
                        <div class="card-action">
                            <p class="viewproject">View Project</p>
                        </div>
                ...
                <div class="col m4 s12">
                    <a href="biomet.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                         <div class="row imageshowincard">
                            <div class="col s6">
                                <h5>LIC Database Management</h5>
                            </div>
                            <!-- <div class="col s6">
                        ...
                        <div class="card-content">
                            <p>C++ Project to emulate the functioning of LIC.</p>
                        </div>
                        <div class="card-action">
                            <p class="viewproject">View Project</p>
                        </div>
                ...
                <div class="col m4 s12">
                	<a href="c2cwebportal.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                         <div class="row imageshowincard">
                            <div class="col s6">
                        ...
                        <div class="card-content">
                            <p>C++ Implementation of the Periodic table </p>
                        </div>
                        <div class="card-action">
                            <p class="viewproject">View Project</p>
                        </div>
