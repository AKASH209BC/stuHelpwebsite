...
<html>
  <head>
    ...
    <title>stuHelp | Social Science</title>
  ...
  <body>
    ...
    <div class="section #424242 grey darken-3" style="color: white;">
        <div style="padding-left: 20px;">
            <h5>SOCIAL SCIENCE PROJECTS</h5>
            <p>Check out the best social science school projects available online </p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- so this is the project card which is going to repeat -->
                    <a href="modellingrstruc.html" style="color: black;">
                    <div class="card animated fadeIn" style="border-bottom: 10px solid red;">
                        <div class=" row imageshowincard">
                            <div class="col s6">
                                <h5>Modelling Disaster Resilient Structures</h5>
                            </div>
                        </div>
                        <div class="card-content">
                            <p>Disaster Management Project on making layouts of models based on structural improvements in buildings in disaster prone areas.</p>
                        </div>
                ...
                <div class="col m4 s12">
                    <a href="governmentrole.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                         <div class="row imageshowincard">
                            <div class="col s6">
                                <h5>Government's role during disasters</h5>
                            </div>
                            <!-- <div class="col s6">
                        ...
                        <div class="card-content">
                            <p>Disaster Management Project based on surveying governments role during disasters from people and also understanding government's perspective from local government functionaries.</p>
                        </div>
                        <div class="card-action" >
                            <p class="viewproject">View Project</p>
                        </div>
                ...
                <div class="col m4 s12">
                    <a href="demonetisation.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                         <div class="row imageshowincard">
                            <div class="col s6">
                                <h5>Demonetisation in India</h5>
                            </div>
                           
                        </div>
                        <div class="card-content">
                            <p>Economics Project studying the effect of Demonetisation in India during various parts of India's History.</p>
                        </div>
                        <div class="card-action">
                            <p class="viewproject">View Project</p>
                        </div>
            ...
            <div class="row" style="margin-bottom: 0;">
                <div class="col m4 s12">
                <!-- so this is the project card which is going to repeat -->
                    <a href="votingrotingsw.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                        <div class=" row imageshowincard">
                            <div class="col s6">
                                <h5>Voting Rights for Women</h5>
                            </div>
                            <!-- <div class="col s6">
                        ...
                        <div class="card-content">
                            <p>Political Science Project mapping the time line of women's struggle to achieve voting rights and relating it to the concept of equality in democracy.</p>
                        </div>
                        <div class="card-action">
                            <p class="viewproject">View Project</p>
                        </div>
                ...
                <div class="col m4 s12">
                    <a href="ww2.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                         <div class="row imageshowincard">
                            <div class="col s6">
                                <h5>World War II</h5>
                        ...
                        <div class="card-content">
                            <p>History Project detailing the causes and effects of world war 2</p>
                        </div>
                        <div class="card-action">
                            <p class="viewproject">View Project</p>
                        </div>
                ...
                <div class="col m4 s12">
                	<a href="indianc.html" style="color: black;">
                    <div class="card" style="border-bottom: 10px solid red;">
                         <div class="row imageshowincard">
                            <div class="col s6">
                                <h5>Indian Constitution: Boon or Bane</h5>
                            </div> 
                            <!-- <div class="col s6">
                        ...
                        <div class="card-content">
                            <p>Political Science Project detailing author's take on whether the constitution is fallible or infallible?</p>
                        </div>
                        <div class="card-action">
                            <p class="viewproject">View Project</p>
                        </div>
